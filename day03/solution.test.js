...
818181911112111`;
    ...
    describe('findBiggestMultiDigitNumber', () => {
        it('can find it in 987654321111111', () => {
            expect(day03.findBiggestTwoDigitNumber('987654321111111')).toBe(987654321111)
        })
        it('can find it in 811111111111119', () => {
            expect(day03.findBiggestTwoDigitNumber('811111111111119')).toBe(811111111119)
        })
        it('can find it in 234234234234278', () => {
            expect(day03.findBiggestTwoDigitNumber('234234234234278')).toBe(434234234278)
        })
        it('can find it in 818181911112111', () => {
            expect(day03.findBiggestTwoDigitNumber('818181911112111')).toBe(888911112111)
        })
    })
});
